...
<input name="main_Duration" id="main_Duration">
            ...
            <div class="cntr">
                <label for="rdo-1" class="btn-radio" style="margin-top: 20px">
                  ...
                  <span class="span">           ساعة وحدة   </span>  <p class="sanad"  >100  SR </p>
                </label>
                ...
                <label for="rdo-2" class="btn-radio">
                  ...
                  <span class="span">           6 ساعات  </span>  <p class="sanad"  >550 SR </p>
                </label>
                ...
                <label for="rdo-3" class="btn-radio">
                  ...
                  <span class="span">           10 ساعات  </span>  <p class="sanad"  >800 SR </p>
                </label>
...
<hr>
                            {{-- ساعات مخصصة      --}}
              <br>
              <p >او يمكنك اختيار عدد الساعات التي تناسبك , مع العلم  أن َّ قيمة الساعة الواحدة 100 SR .. </p>
...

{
    ...
    if (val == 6 )
{        document.getElementById("p2").innerHTML = 550 + " SR";
    document.getElementById("main_price").value=550;
    document.getElementById("main_Duration").value=val;
}
    else if (val == 10 )
    {        document.getElementById("p2").innerHTML = 800 + " SR";
    document.getElementById("main_price").value=800;
    document.getElementById("main_Duration").value=val;

}
   else if (val == 12 )
   {        document.getElementById("p2").innerHTML = 1100 + " SR";
   document.getElementById("main_price").value=1100;
   document.getElementById("main_Duration").value=val;

}
    else
    {
        document.getElementById("p2").innerHTML = val*100 + " SR";
        document.getElementById("main_price").value=val*100;
        document.getElementById("main_Duration").value=val;
    }
}
...

    {
        ...
        if (val ==1 )
{            document.getElementById("main_price").value=100;
        document.getElementById("main_Duration").value=val;}
