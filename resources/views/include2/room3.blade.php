...
<form method="POST" action="{{ route('booking') }}" class="form-card" name="myForm">
    @csrf
        ...
        <legend class="form-legend">
           ...
           <center><h5 class="form--hint" style="color:#dc3545">{{ request()->cookie("error") }}</h5></center>
...
<input name="main_Duration" id="main_Duration">
            ...
            <div class="cntr">
                <label for="rdo-1" class="btn-radio" style="margin-top: 20px">
                  ...
                  <span class="span">           ساعة وحدة   </span>  <p class="sanad"  >45  SR </p>
                </label>


                <label for="rdo-2" class="btn-radio">
                  <input type="radio" id="rdo-2" name="Duration" value="24" onchange="myFunction2(this.value)" >
                  <svg width="20px" height="20px" viewBox="0 0 20 20">
                    <circle cx="10" cy="10" r="9"></circle>
                    <path d="M10,7 C8.34314575,7 7,8.34314575 7,10 C7,11.6568542 8.34314575,13 10,13 C11.6568542,13 13,11.6568542 13,10 C13,8.34314575 11.6568542,7 10,7 Z" class="inner"></path>
                    <path d="M10,1 L10,1 L10,1 C14.9705627,1 19,5.02943725 19,10 L19,10 L19,10 C19,14.9705627 14.9705627,19 10,19 L10,19 L10,19 C5.02943725,19 1,14.9705627 1,10 L1,10 L1,10 C1,5.02943725 5.02943725,1 10,1 L10,1 Z" class="outer"></path>
                  </svg>
                  <span class="span">            يوم كامل  </span>  <p class="sanad"  >250 SR </p>
                </label>

                <label for="rdo-3" class="btn-radio">
                  <input type="radio" id="rdo-3" name="Duration" value="0"  onchange="myFunction2(this.value)">
                  <svg width="20px" height="20px" viewBox="0 0 20 20">
                    <circle cx="10" cy="10" r="9"></circle>
                    <path d="M10,7 C8.34314575,7 7,8.34314575 7,10 C7,11.6568542 8.34314575,13 10,13 C11.6568542,13 13,11.6568542 13,10 C13,8.34314575 11.6568542,7 10,7 Z" class="inner"></path>
                    <path d="M10,1 L10,1 L10,1 C14.9705627,1 19,5.02943725 19,10 L19,10 L19,10 C19,14.9705627 14.9705627,19 10,19 L10,19 L10,19 C5.02943725,19 1,14.9705627 1,10 L1,10 L1,10 C1,5.02943725 5.02943725,1 10,1 L10,1 Z" class="outer"></path>
                  </svg>
                  <span class="span">           شهر كامل  </span>  <p class="sanad"  >2000 SR </p>
                </label>
...
<hr>
                            {{-- ساعات مخصصة      --}}
              <br>
              <p >او يمكنك اختيار عدد الساعات التي تناسبك , مع العلم  أن َّ قيمة الساعة الواحدة 45 SR .. </p>
...

{
    ...
    if (val == 6 )
{        document.getElementById("p2").innerHTML = 40 + " SR";
    document.getElementById("main_price").value=40;
    document.getElementById("main_Duration").value=val;
}
    else if (val == 24 )
    {        document.getElementById("p2").innerHTML = 250 + " SR";
    document.getElementById("main_price").value=250;
    document.getElementById("main_Duration").value=val;

}
   else if (val == 0 )
   {        document.getElementById("p2").innerHTML = 2000 + " SR";
   document.getElementById("main_price").value=2000;
   document.getElementById("main_Duration").value=val;

}
    else
    {
        document.getElementById("p2").innerHTML = val*40 + " SR";
        document.getElementById("main_price").value=val*40;
        document.getElementById("main_Duration").value=val;
    }
}
...
{            document.getElementById("main_price").value=2000;
        document.getElementById("main_Duration").value=val;
                        ...
                        <div><center><p class="choice" style="width:auto;  font-size:13px;text-align:right">بإكمالك تسجيل الحجز أنت توافق على شروطنا التالية :   <br>
                            1- الإلتزام بالوقت المحدد .  <br>
                            2-  الحرص على نظافة المكان .  <br>
                            3-  الإلتزام بالأدب والذوق العام .  <br>
...
function validateAndSend() {
    ...
    if ( (myForm.main_Duration.value    == '' ||  myForm.main_Duration.value >13 || myForm.main_Duration.value <0)  && myForm.main_Duration.value !=24 )
    {
